    ...
    <div class="table-wrap">
      <table class="dtable">
        ...
        <tbody>
          ...
          <tr v-if="!rows.length">
            <td colspan="10" class="hint-row">請先選擇【執行方式】，再填寫其他欄位，勾選後點擊「新增」</td>
          </tr>
        </tbody>
      </table>
    </div>
...
function emptyForm() { return { execMode: '01', productKey: '', spec1: '', spec2: '', spec3: '', qty: null, lotNo: '', repLotNo: '', remark: '' } }
